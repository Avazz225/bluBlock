        ...
        child:Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('''Wir versuchen aber das zu verhindern. Darum haben wir standardmäßig kleine Blockpakete und relativ lange Wartezeiten eingebaut (Diese können auch angepasst werden!).\nDennoch können wir nicht versprechen, dass die Plattformen keine Konten sperren oder zumindest einschränken.'''),
              Text('\n'),
              Text('Wirkt sich BluBlock negativ auf meinen Akku aus?', style: TextStyle(fontWeight: FontWeight.bold)),
              Text(''),
              Text('''Das kommt auf die Einstellung an.'''),
              Text('''Standardmäßig arbeitet BluBlock nur in der Nacht (Auch das kann eingestellt werden.).\nDamit versuchen wir den Akkuverbrauch am Tag auf ein Minimum zu beschränken.'''),
              Text('\n'),
